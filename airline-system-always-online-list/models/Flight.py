    ...
    def construct_flights(self):
        ...
        for f in self.flight['itineraries']:
            ...
            if len(self.flight['itineraries'][index]['segments']) == 2:  # one stop flight
                ...
                offer[f'{("O", "C")[index < 1]}firstFlightDepartureAirport'] = \
                    self.flight['itineraries'][index]['segments'][0]['departure']['iataCode']
                offer[f'{("O", "C")[index < 1]}firstFlightAirlineLogo'] = get_airline_logo(
                    self.flight['itineraries'][index]['segments'][0]['carrierCode'])
                offer[f'{("O", "C")[index < 1]}firstFlightAirline'] = self.flight['itineraries'][index]['segments'][0][
                    'carrierCode']
                offer[f'{("O", "C")[index < 1]}firstFlightDepartureDate'] = get_hour(
                    self.flight['itineraries'][index]['segments'][0]['departure']['at'])
                offer[f'{("O", "C")[index < 1]}firstFlightArrivalAirport'] = \
                    self.flight['itineraries'][index]['segments'][0]['arrival']['iataCode']
                offer[f'{("O", "C")[index < 1]}firstFlightArrivalDate'] = get_hour(
                    self.flight['itineraries'][index]['segments'][0]['arrival']['at'])
                offer[f'{("O", "C")[index < 1]}firstFlightArrivalDuration'] = \
                    self.flight['itineraries'][index]['segments'][0][
                        'duration']
                offer[f'{("O", "C")[index < 1]}secondFlightDepartureAirport'] = \
                    self.flight['itineraries'][index]['segments'][1]['departure']['iataCode']
                offer[f'{("O", "C")[index < 1]}secondFlightDepartureDate'] = get_hour(
                    self.flight['itineraries'][index]['segments'][1]['departure']['at'])
                offer[f'{("O", "C")[index < 1]}secondFlightAirlineLogo'] = get_airline_logo(
                    self.flight['itineraries'][index]['segments'][1]['carrierCode'])
                offer[f'{("O", "C")[index < 1]}secondFlightAirline'] = self.flight['itineraries'][index]['segments'][1][
                    'carrierCode']
                offer[f'{("O", "C")[index < 1]}secondFlightArrivalAirport'] = \
                    self.flight['itineraries'][index]['segments'][1]['arrival']['iataCode']
                offer[f'{("O", "C")[index < 1]}secondFlightArrivalDate'] = get_hour(
                    self.flight['itineraries'][index]['segments'][1]['arrival']['at'])
                offer[f'{("O", "C")[index < 1]}secondFlightArrivalDuration'] = \
                    self.flight['itineraries'][index]['segments'][1][
                        'duration']
                offer[f'{("O", "C")[index < 1]}FlightTotalDuration'] = self.flight['itineraries'][index]['duration'][2:]
                offer[f'{("O", "C")[index < 1]}stop_time'] = get_stoptime(self.flight['itineraries'][index]['duration'],
                                                                          offer[
                                                                              f'{("O", "C")[index < 1]}firstFlightArrivalDuration'],
                                                                          offer[
                                                                              f'{("O", "C")[index < 1]}secondFlightArrivalDuration'])
                ...
                offer[f'{("O", "C") [index < 1]}firstFlightAirlineLogo'] = get_airline_logo(
                    self.flight['itineraries'][index]['segments'][0]['carrierCode'])
                offer[f'{("O", "C") [index < 1]}firstFlightAirline'] = self.flight['itineraries'][index]['segments'][0]['carrierCode']
                offer[f'{("O", "C") [index < 1]}firstFlightDepartureDate'] = get_hour(
                    self.flight['itineraries'][index]['segments'][0]['departure']['at'])
                offer[f'{("O", "C") [index < 1]}firstFlightArrivalAirport'] = \
                    self.flight['itineraries'][index]['segments'][0]['arrival']['iataCode']
                offer[f'{("O", "C") [index < 1]}firstFlightArrivalDate'] = get_hour(
                    self.flight['itineraries'][index]['segments'][0]['arrival']['at'])
                offer[f'{("O", "C") [index < 1]}firstFlightArrivalDuration'] = self.flight['itineraries'][index]['segments'][0][
                    'duration']
                offer[f'{("O", "C") [index < 1]}FlightTotalDuration'] = self.flight['itineraries'][index]['duration'][2:]
